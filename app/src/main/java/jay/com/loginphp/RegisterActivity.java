        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !retypepassword.isEmpty()) {
                    if(inputPassword.getText().toString().trim().equals(inputretypePassword.getText().toString().trim())) {
                        if (inputFullName.getText().toString() == null || inputFullName.getText().toString().length() > 50 || inputFullName.getText().toString().length() < 3) {
                            inputFullName.setError("Enter name between 3 to 50 charecter");
                            //Toast.makeText(RegisterActivity.this, "Enter name between 3 to 50 Charecter", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        inputretypePassword.setError("Make Sure both password are same!");
                        //Toast.makeText(RegisterActivity.this, "Make Sure both password are same!", Toast.LENGTH_SHORT).show();
                    }
                } else {
